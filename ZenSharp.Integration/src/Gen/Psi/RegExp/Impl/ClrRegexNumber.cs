...
{
  internal partial class ClrRegexNumber : JetBrains.ReSharper.Psi.RegExp.ClrRegex.Impl.Tree.ClrRegexCompositeElement, JetBrains.ReSharper.Psi.RegExp.ClrRegex.Tree.IClrRegexNumber
  {
    internal ClrRegexNumber() : base() { }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType
    {
      get { return JetBrains.ReSharper.Psi.RegExp.ClrRegex.Impl.Tree.ElementType.CLR_REGEX_NUMBER; }
    }
    public  void Accept(JetBrains.ReSharper.Psi.RegExp.ClrRegex.Tree.TreeNodeVisitor visitor)
    {
      visitor.VisitClrRegexNumber(this);
    }
    ...
    {
      visitor.VisitClrRegexNumber(this, context);
    }
    ...
    {
      return visitor.VisitClrRegexNumber(this, context);
    }
    public override string ToString()
    {
      return "IClrRegexNumber";
    }
  }
}
