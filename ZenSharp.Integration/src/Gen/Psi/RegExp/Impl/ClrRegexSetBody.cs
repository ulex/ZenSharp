...
{
  internal partial class ClrRegexSetBody : JetBrains.ReSharper.Psi.RegExp.ClrRegex.Impl.Tree.ClrRegexCompositeElement, JetBrains.ReSharper.Psi.RegExp.ClrRegex.Tree.IClrRegexSetBody
  {
    internal ClrRegexSetBody() : base() { }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType
    {
      get { return JetBrains.ReSharper.Psi.RegExp.ClrRegex.Impl.Tree.ElementType.CLR_REGEX_SET_BODY; }
    }
    public  void Accept(JetBrains.ReSharper.Psi.RegExp.ClrRegex.Tree.TreeNodeVisitor visitor)
    {
      visitor.VisitClrRegexSetBody(this);
    }
    ...
    {
      visitor.VisitClrRegexSetBody(this, context);
    }
    ...
    {
      return visitor.VisitClrRegexSetBody(this, context);
    }
    public override string ToString()
    {
      return "IClrRegexSetBody";
    }
  }
}
