...
{
  internal partial class ClrRegexName : JetBrains.ReSharper.Psi.RegExp.ClrRegex.Impl.Tree.ClrRegexCompositeElement, JetBrains.ReSharper.Psi.RegExp.ClrRegex.Tree.IClrRegexName
  {
    internal ClrRegexName() : base() { }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType
    {
      get { return JetBrains.ReSharper.Psi.RegExp.ClrRegex.Impl.Tree.ElementType.CLR_REGEX_NAME; }
    }
    public  void Accept(JetBrains.ReSharper.Psi.RegExp.ClrRegex.Tree.TreeNodeVisitor visitor)
    {
      visitor.VisitClrRegexName(this);
    }
    ...
    {
      visitor.VisitClrRegexName(this, context);
    }
    ...
    {
      return visitor.VisitClrRegexName(this, context);
    }
    public override string ToString()
    {
      return "IClrRegexName";
    }
  }
}
