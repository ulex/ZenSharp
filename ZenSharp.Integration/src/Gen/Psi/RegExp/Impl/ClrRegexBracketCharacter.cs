...
{
  internal partial class ClrRegexBracketCharacter : JetBrains.ReSharper.Psi.RegExp.ClrRegex.Impl.Tree.ClrRegexCompositeElement, JetBrains.ReSharper.Psi.RegExp.ClrRegex.Tree.IClrRegexBracketCharacter
  {
    internal ClrRegexBracketCharacter() : base() { }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType
    {
      get { return JetBrains.ReSharper.Psi.RegExp.ClrRegex.Impl.Tree.ElementType.CLR_REGEX_BRACKET_CHARACTER; }
    }
    public  void Accept(JetBrains.ReSharper.Psi.RegExp.ClrRegex.Tree.TreeNodeVisitor visitor)
    {
      visitor.VisitClrRegexBracketCharacter(this);
    }
    ...
    {
      visitor.VisitClrRegexBracketCharacter(this, context);
    }
    ...
    {
      return visitor.VisitClrRegexBracketCharacter(this, context);
    }
    public override string ToString()
    {
      return "IClrRegexBracketCharacter";
    }
  }
}
