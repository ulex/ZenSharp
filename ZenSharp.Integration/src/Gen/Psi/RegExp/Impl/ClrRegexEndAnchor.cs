...
{
  internal partial class ClrRegexEndAnchor : JetBrains.ReSharper.Psi.RegExp.ClrRegex.Impl.Tree.ClrRegexCompositeElement, JetBrains.ReSharper.Psi.RegExp.ClrRegex.Tree.IClrRegexEndAnchor
  {
    internal ClrRegexEndAnchor() : base() { }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType
    {
      get { return JetBrains.ReSharper.Psi.RegExp.ClrRegex.Impl.Tree.ElementType.CLR_REGEX_END_ANCHOR; }
    }
    public  void Accept(JetBrains.ReSharper.Psi.RegExp.ClrRegex.Tree.TreeNodeVisitor visitor)
    {
      visitor.VisitClrRegexEndAnchor(this);
    }
    ...
    {
      visitor.VisitClrRegexEndAnchor(this, context);
    }
    ...
    {
      return visitor.VisitClrRegexEndAnchor(this, context);
    }
    public override string ToString()
    {
      return "IClrRegexEndAnchor";
    }
  }
}
