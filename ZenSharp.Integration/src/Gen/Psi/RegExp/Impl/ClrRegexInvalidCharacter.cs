...
{
  internal partial class ClrRegexInvalidCharacter : JetBrains.ReSharper.Psi.RegExp.ClrRegex.Impl.Tree.ClrRegexCompositeElement, JetBrains.ReSharper.Psi.RegExp.ClrRegex.Tree.IClrRegexInvalidCharacter
  {
    internal ClrRegexInvalidCharacter() : base() { }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType
    {
      get { return JetBrains.ReSharper.Psi.RegExp.ClrRegex.Impl.Tree.ElementType.CLR_REGEX_INVALID_CHARACTER; }
    }
    public  void Accept(JetBrains.ReSharper.Psi.RegExp.ClrRegex.Tree.TreeNodeVisitor visitor)
    {
      visitor.VisitClrRegexInvalidCharacter(this);
    }
    ...
    {
      visitor.VisitClrRegexInvalidCharacter(this, context);
    }
    ...
    {
      return visitor.VisitClrRegexInvalidCharacter(this, context);
    }
    public override string ToString()
    {
      return "IClrRegexInvalidCharacter";
    }
  }
}
