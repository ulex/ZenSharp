...
{
  internal partial class ClrRegexStartAnchor : JetBrains.ReSharper.Psi.RegExp.ClrRegex.Impl.Tree.ClrRegexCompositeElement, JetBrains.ReSharper.Psi.RegExp.ClrRegex.Tree.IClrRegexStartAnchor
  {
    internal ClrRegexStartAnchor() : base() { }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType
    {
      get { return JetBrains.ReSharper.Psi.RegExp.ClrRegex.Impl.Tree.ElementType.CLR_REGEX_START_ANCHOR; }
    }
    public  void Accept(JetBrains.ReSharper.Psi.RegExp.ClrRegex.Tree.TreeNodeVisitor visitor)
    {
      visitor.VisitClrRegexStartAnchor(this);
    }
    ...
    {
      visitor.VisitClrRegexStartAnchor(this, context);
    }
    ...
    {
      return visitor.VisitClrRegexStartAnchor(this, context);
    }
    public override string ToString()
    {
      return "IClrRegexStartAnchor";
    }
  }
}
