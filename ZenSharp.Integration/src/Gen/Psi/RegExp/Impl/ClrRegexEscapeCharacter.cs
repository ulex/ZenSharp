...
{
  internal partial class ClrRegexEscapeCharacter : JetBrains.ReSharper.Psi.RegExp.ClrRegex.Impl.Tree.ClrRegexCompositeElement, JetBrains.ReSharper.Psi.RegExp.ClrRegex.Tree.IClrRegexEscapeCharacter
  {
    internal ClrRegexEscapeCharacter() : base() { }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType
    {
      get { return JetBrains.ReSharper.Psi.RegExp.ClrRegex.Impl.Tree.ElementType.CLR_REGEX_ESCAPE_CHARACTER; }
    }
    public  void Accept(JetBrains.ReSharper.Psi.RegExp.ClrRegex.Tree.TreeNodeVisitor visitor)
    {
      visitor.VisitClrRegexEscapeCharacter(this);
    }
    ...
    {
      visitor.VisitClrRegexEscapeCharacter(this, context);
    }
    ...
    {
      return visitor.VisitClrRegexEscapeCharacter(this, context);
    }
    public override string ToString()
    {
      return "IClrRegexEscapeCharacter";
    }
  }
}
