...
{
  internal partial class ClrRegexSimpleGroup : JetBrains.ReSharper.Psi.RegExp.ClrRegex.Impl.Tree.ClrRegexCompositeElement, JetBrains.ReSharper.Psi.RegExp.ClrRegex.Tree.IClrRegexSimpleGroup
  {
    ...
    internal ClrRegexSimpleGroup() : base() { }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType
    {
      get { return JetBrains.ReSharper.Psi.RegExp.ClrRegex.Impl.Tree.ElementType.CLR_REGEX_SIMPLE_GROUP; }
    }
    public  void Accept(JetBrains.ReSharper.Psi.RegExp.ClrRegex.Tree.TreeNodeVisitor visitor)
    {
      visitor.VisitClrRegexSimpleGroup(this);
    }
    ...
    {
      visitor.VisitClrRegexSimpleGroup(this, context);
    }
    ...
    {
      return visitor.VisitClrRegexSimpleGroup(this, context);
    }
