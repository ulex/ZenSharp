...
{
  internal partial class ClrRegexPrefixGroup : JetBrains.ReSharper.Psi.RegExp.ClrRegex.Impl.Tree.ClrRegexCompositeElement, JetBrains.ReSharper.Psi.RegExp.ClrRegex.Tree.IClrRegexPrefixGroup
  {
    public const short REGEXP_LPARENTH = ChildRole.REGEXP_LPARENTH;
    public const short REGEXP_QUESTION = ChildRole.REGEXP_QUESTION;
    public const short REGEXP_PREFIX = ChildRole.REGEXP_PREFIX;
    ...
    internal ClrRegexPrefixGroup() : base() { }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType
    {
      get { return JetBrains.ReSharper.Psi.RegExp.ClrRegex.Impl.Tree.ElementType.CLR_REGEX_PREFIX_GROUP; }
    }
    public  void Accept(JetBrains.ReSharper.Psi.RegExp.ClrRegex.Tree.TreeNodeVisitor visitor)
    {
      visitor.VisitClrRegexPrefixGroup(this);
    }
    ...
    {
      visitor.VisitClrRegexPrefixGroup(this, context);
    }
    ...
    {
      return visitor.VisitClrRegexPrefixGroup(this, context);
    }
    public override short GetChildRole(JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.TreeElement child)
    {
      switch (child.NodeType.Index)
      {
        ...
        case JetBrains.ReSharper.Psi.RegExp.ClrRegex.Impl.Tree.ElementType.CLR_REGEX_GROUP_PREFIX_NODE_TYPE_INDEX:
    ...
    public virtual JetBrains.ReSharper.Psi.RegExp.ClrRegex.Tree.IClrRegexGroupPrefix Prefix
    {
      get { return (JetBrains.ReSharper.Psi.RegExp.ClrRegex.Tree.IClrRegexGroupPrefix) FindChildByRole(REGEXP_PREFIX); }
    }
    ...
    public virtual JetBrains.ReSharper.Psi.RegExp.ClrRegex.Tree.IClrRegexGroupPrefix SetPrefix(JetBrains.ReSharper.Psi.RegExp.ClrRegex.Tree.IClrRegexGroupPrefix param)
    {
      using (JetBrains.ReSharper.Resources.Shell.WriteLockCookie.Create(this.IsPhysical()))
      {
        ...
        JetBrains.ReSharper.Psi.RegExp.ClrRegex.Tree.IClrRegexGroupPrefix result = null;
        ...
        else if (next.NodeType == JetBrains.ReSharper.Psi.RegExp.ClrRegex.Impl.Tree.ElementType.CLR_REGEX_GROUP_PREFIX)
        {
          if (param != null)
          {
    ...
    public virtual JetBrains.ReSharper.Psi.RegExp.ClrRegex.Tree.IClrRegularExpression SetRegularExpression(JetBrains.ReSharper.Psi.RegExp.ClrRegex.Tree.IClrRegularExpression param)
    {
      using (JetBrains.ReSharper.Resources.Shell.WriteLockCookie.Create(this.IsPhysical()))
      {
        ...
        next = GetNextFilteredChild(current);
        if (next != null && next.NodeType == JetBrains.ReSharper.Psi.RegExp.ClrRegex.Impl.Tree.ElementType.CLR_REGEX_GROUP_PREFIX)
        {
          current = next;
        }
        else
