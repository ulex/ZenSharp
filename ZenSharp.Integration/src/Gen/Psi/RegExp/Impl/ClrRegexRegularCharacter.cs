...
{
  internal partial class ClrRegexRegularCharacter : JetBrains.ReSharper.Psi.RegExp.ClrRegex.Impl.Tree.ClrRegexCompositeElement, JetBrains.ReSharper.Psi.RegExp.ClrRegex.Tree.IClrRegexRegularCharacter
  {
    internal ClrRegexRegularCharacter() : base() { }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType
    {
      get { return JetBrains.ReSharper.Psi.RegExp.ClrRegex.Impl.Tree.ElementType.CLR_REGEX_REGULAR_CHARACTER; }
    }
    public  void Accept(JetBrains.ReSharper.Psi.RegExp.ClrRegex.Tree.TreeNodeVisitor visitor)
    {
      visitor.VisitClrRegexRegularCharacter(this);
    }
    ...
    {
      visitor.VisitClrRegexRegularCharacter(this, context);
    }
    ...
    {
      return visitor.VisitClrRegexRegularCharacter(this, context);
    }
    public override string ToString()
    {
      return "IClrRegexRegularCharacter";
    }
  }
}
