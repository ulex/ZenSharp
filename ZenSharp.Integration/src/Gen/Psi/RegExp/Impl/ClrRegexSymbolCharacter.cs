...
{
  internal partial class ClrRegexSymbolCharacter : JetBrains.ReSharper.Psi.RegExp.ClrRegex.Impl.Tree.ClrRegexCompositeElement, JetBrains.ReSharper.Psi.RegExp.ClrRegex.Tree.IClrRegexSymbolCharacter
  {
    internal ClrRegexSymbolCharacter() : base() { }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType
    {
      get { return JetBrains.ReSharper.Psi.RegExp.ClrRegex.Impl.Tree.ElementType.CLR_REGEX_SYMBOL_CHARACTER; }
    }
    public  void Accept(JetBrains.ReSharper.Psi.RegExp.ClrRegex.Tree.TreeNodeVisitor visitor)
    {
      visitor.VisitClrRegexSymbolCharacter(this);
    }
    ...
    {
      visitor.VisitClrRegexSymbolCharacter(this, context);
    }
    ...
    {
      return visitor.VisitClrRegexSymbolCharacter(this, context);
    }
    public override string ToString()
    {
      return "IClrRegexSymbolCharacter";
    }
  }
}
